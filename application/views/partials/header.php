            ...
            <nav id="navbar">
              <div class="container-fluid">
                ...
                <div id="pr-navbar">
                  ...
                  <ul id="pr-nav-right">
                      <li <?php if (current_url() == base_url('admin')) { echo 'class="active"'; } ?>><a href="<?=base_url('admin')?>"><span class="admin-icon"></span>&nbsp;Admin</a></li>
                      <li class="hidden-xs raton-normal"><a>|</a></li>
                      <li><a href="<?=base_url('auth/logout')?>"><span class="logout-icon"></span>&nbsp;Logout</a></li>
                  </ul>
                </div>
              </div>
            </nav>
